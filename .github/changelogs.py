...
REGISTRY = "ghcr.io/barqos/"
COSIGN_KEY = "https://raw.githubusercontent.com/barqos/Image/refs/heads/main/cosign.pub"
...
OTHER_NAMES = {
    ...
    "kde": "### [Barq Images](https://github.com/barqos/Image)\n| | Name | Previous | New |\n| --- | --- | --- | --- |{changes}\n\n",
    "nvidia-open": "### Nvidia Images\n| | Name | Previous | New |\n| --- | --- | --- | --- |{changes}\n\n",

}

COMMITS_FORMAT = "### Commits\n| Hash | Subject | Author |\n| --- | --- | --- |{commits}\n\n"
COMMIT_FORMAT = "\n| **[{short}](https://github.com/barqos/Image/commit/{githash})** | {subject} | {author} |"
...
# For this Stream
sudo bootc switch --enforce-container-sigpolicy ghcr.io/barqos/$IMAGE_NAME:{target}

# For this Specific Image:
sudo bootc switch --enforce-container-sigpolicy ghcr.io/barqos/$IMAGE_NAME:{curr}
```

### Documentation
Be sure to read the [documentation](https://github.com/barqos/Image) for more information on how to use your cloud native system.
"""
...
def get_tags(target: str, manifests: dict[str, Any]):
    """
    >>> imgs = lambda tags: {"barq": {"RepoTags": tags}}
